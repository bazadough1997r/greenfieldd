...
const useStyles = makeStyles((theme) => ({root: {flexGrow: 1}, title: {flexGrow: 1}}));
  ...
  return (
    <div style ={{
     ...
     <Grid container><Grid
      ...
      <Grid item xs={2}>
      <Grid>
        <Typography component="div" style={{  color : '#F9FBE7',  fontStyle: 'italic', fontSize: 25, padding:'10px 5px 0px 5px' }} >
      ...
      <Grid>
        <Typography component="div" style={{ height: '7vh' , width :'100vh', color : '#F9FBE7',  fontStyle: 'italic', fontSize: 25, padding:'10px 3px 0px 5px', margin:'-50px 10px 10px 50px' }} >carsooq@join.com</Typography>
      </Grid>
      </Grid>
    </Paper>
    </Grid>
    ...
    <Grid>
      <MyTypography  align='center' variant='subtitle1'>&copy;{new Date().getFullYear()} CarSooq | All right reserved | Terms Of Service | Privacy</MyTypography></Grid>
